...
class Sklip():
    ...
    def stage1(self, subdir='stage1'): #changed subdir default
        ...
        coron1pipeline.run_obs(database=self.Database,
                               skip_fnoise=True, # Test for HD21997 NIRCam
    ...
    def nircam_image_processing_wrong(self):
        ImageTools = imagetools.ImageTools(database=self.Database)
    ...
    def nircam_image_processing_v0(self):
        ...
        ImageTools.blur_frames(fact=fact, # 200 or 444 should probably not need bluring -- if use just use default
                            types=['SCI', 'SCI_BG', 'REF', 'REF_BG'],
                            subdir='blurred')
